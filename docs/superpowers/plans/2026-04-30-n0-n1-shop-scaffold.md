...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_game_state.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_save_migration.tscn
```
...
> 计数：v1 测试 1(version) + 3(preserved) + 1(reputation) + 8(stripped) = 13；v2 测试 1+1=2；合计 15。
...
- 公开 migrate() 供测试调用
- 测试: test_save_migration 15 PASS"
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot --quit-after 2
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_recipe_data.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_customer_data.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_gupu_data.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_narrative_card.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_time_line.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_shop_state.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/test_save_with_shopstate.tscn
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot --quit-after 3
```
...
```bash
"D:/soft/GODOT/Godot_v4.6.2-stable_win64_console.exe" --headless --path godot res://scenes/test/playtest_n1_smoke.tscn
```
